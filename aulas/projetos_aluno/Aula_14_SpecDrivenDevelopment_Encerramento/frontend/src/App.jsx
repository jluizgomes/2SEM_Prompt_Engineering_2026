    ...
    <div className="app">
      ...
      {info.implementado === false && (
        <div className="banner incompleto">
          ⚠️ Este exercício ainda tem TODOs pendentes no <code>main.py</code> — complete o código
          para habilitar as respostas reais. As ações abaixo devem falhar com a mensagem "TODO".
        </div>
      )}
      {(info.avisos || []).map((a, i) => (
