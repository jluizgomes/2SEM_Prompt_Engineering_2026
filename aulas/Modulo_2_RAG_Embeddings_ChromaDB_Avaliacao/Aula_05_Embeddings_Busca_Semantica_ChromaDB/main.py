...
def indexar() -> None:
    ...
    # TODO: Use vectorstore.add_documents() para indexar DOCUMENTOS
    # TODO: Imprima quantos documentos foram indexados
    pass


def buscar(consulta: str, k: int = 2) -> None:
    """Busca semântica: retorna os documentos mais próximos em significado."""
    # TODO: Use vectorstore.similarity_search() com a consulta e k
    # TODO: Imprima os resultados numerados
    pass
