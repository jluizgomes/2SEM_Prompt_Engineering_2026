...
PydanticOutputParser + BaseModel: força o LLM a responder com um schema garantido (contrato de saída).
...
```bash
cd Aula_03_Structured_Output_Pydantic_v2
...
```bash
./rodar.sh          # prepara o ambiente e sobe em http://127.0.0.1:8103
