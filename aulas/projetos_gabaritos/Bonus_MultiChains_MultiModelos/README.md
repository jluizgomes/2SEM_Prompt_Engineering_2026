...
Executa várias chains em paralelo (RunnableParallel) e combina respostas de mais de um modelo.
...
```bash
cd Bonus_MultiChains_MultiModelos
...
```bash
./rodar.sh          # prepara o ambiente e sobe em http://127.0.0.1:8199
