...
Chain LCEL completa (prompt | modelo | parser) com StrOutputParser, JsonOutputParser e streaming — substitui o chamar_llm() manual do 1º semestre.
...
```bash
./rodar.sh          # prepara o ambiente e sobe em http://127.0.0.1:8101
