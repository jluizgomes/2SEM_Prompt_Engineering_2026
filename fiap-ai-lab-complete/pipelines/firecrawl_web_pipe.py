...
class Pipeline:
    class Valves(BaseModel):
        ...
        MODEL: str = Field(
            # Default = CHAT_MODEL do container de pipelines (mesmo modelo
            # do .env), para o "Firecrawl Web" não apontar para um modelo
            # que não existe no Ollama do lab.
            default=os.getenv("CHAT_MODEL", "qwen3.5:0.8b"),
